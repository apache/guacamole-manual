...
myst:
  substitutions:
    extHumanName: Duo authentication extension
...
.. tab:: Native Webapp (Tomcat)
   ...
   After you are finished configuring Guacamole to use Duo, your
   ``guacamole.properties`` file will contain a section of properties that
   looks like the following (with placeholder values replaced with proper values):
